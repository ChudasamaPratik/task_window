                ...
                <form class="form-sample" method="POST">
                    ...
                    <div class="mt-3">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                ?>
                                    <select class=" form-control" type="text" name="dname" id="edname" onChange="getemp(this.value);" value="" class="form-control" required='true'>
                    ...
                    <div class="mt-3">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <?php
                                $query = "SELECT * FROM `employees` WHERE `EmployeeRole` = '3' AND `flag` = 0";
                                $query_run = mysqli_query($con, $query);
                                if (mysqli_num_rows($query_run) > 0) {

                                ?>
                                    <select class=" form-control" type="text" name="emplist" id="EmployeeName" value="" class="form-control" required='true'>
                    ...
                    <div class="mt-3">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                if (mysqli_num_rows($query_run) > 0) {
                                ?>
                                    <select class=" form-control" type="text" name="pname" class="form-control" required='true' id="ProjectId">
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><button type="button" class="btn btn-inverse-primary editbtn" data-id="<?= $data['tid'] ?>">Edit</button>
                                        <a type="button" class="btn btn-inverse-danger" href="<?php echo 'demo.php?TDid=' . $data['tid']; ?>">Delete</a>
                                    </td>
                                </tr>
                                <?php $number++;  ?>
                        <?php
