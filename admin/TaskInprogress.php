        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php
                        $query = "SELECT tasks.Id as tid,tasks.Status as st,tasks.*,departments.*,employees.*,projects.* FROM `tasks` JOIN `departments` ON departments.ID = tasks.DeptId JOIN employees ON employees.Id = tasks.AssignTaskto JOIN projects ON tasks.ProjectId = projects.ID WHERE tasks.Status = 'Inprogress'";
