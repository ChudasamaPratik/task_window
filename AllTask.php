            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        $id = $_SESSION['user']['Id'];
                        $query = "SELECT tasks.Id as t,tasks.Status as sta, tasks.*,departments.*,projects.*,EmployeeName FROM `tasks` JOIN `departments` ON departments.ID = tasks.DeptId JOIN employees ON employees.Id = tasks.AssignTaskto JOIN projects ON tasks.ProjectId = projects.ID WHERE tasks.AssignTaskto = '$id'";
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo ($data['sta'] == "pending") ? 'Pending Task' : $data['sta']; ?>
                            </td>
